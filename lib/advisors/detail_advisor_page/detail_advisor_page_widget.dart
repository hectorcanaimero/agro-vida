...
import '/components/message_advisor_component_widget.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<AdvisorsRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final detailAdvisorPageAdvisorsRecord = snapshot.data!;
          ...
          child: Scaffold(
            ...
            appBar: AppBar(
              ...
              leading: FlutterFlowIconButton(
                ...
                onPressed: () async {
                  logFirebaseEvent('DETAIL_ADVISOR_arrow_back_rounded_ICN_ON');
                                                      ...
                                                      children: [
                                                        Expanded(
                                                          child: InkWell(
                                                            ...
                                                            onTap: () async {
                                                              logFirebaseEvent(
                                                                  'DETAIL_ADVISOR_Row_kjg8mw4d_ON_TAP');
                                                              logFirebaseEvent(
                                                                  'Row_bottom_sheet');
