...
import 'ofertas_edit_page_model.dart';
export 'ofertas_edit_page_model.dart';
...
class _OfertasEditPageWidgetState extends State<OfertasEditPageWidget> {
  late OfertasEditPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OfertasEditPageModel());
    ...
    return Align(
      ...
      child: StreamBuilder<JobsRecord>(
        ...
        builder: (context, snapshot) {
          ...
          final editarNoteJobsRecord = snapshot.data!;
          return Material(
                              ...
                              child: Column(
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: TextFormField(
                                      controller:
                                          _model.cargoFieldController ??=
                                              TextEditingController(
                                        text: editarNoteJobsRecord.titleJob,
                                      ),
                                      ...
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium,
                                      validator: _model
                                          .cargoFieldControllerValidator
                                          .asValidator(context),
                                    ),
                                  ),
                                  TextFormField(
                                    controller:
                                        _model.empresaFieldController ??=
                                            TextEditingController(
                                      text: editarNoteJobsRecord.company,
                                    ),
                                  ...
                                  TextFormField(
                                    controller:
                                        _model.descriptionFieldController ??=
                                            TextEditingController(
                                      text: editarNoteJobsRecord.description,
                                    ),
                                  ...
                                  TextFormField(
                                    controller: _model.emailFieldController ??=
                                        TextEditingController(
                                      text: editarNoteJobsRecord.email,
                                    ),
                                  ...
                                  TextFormField(
                                    controller: _model.phoneFieldController ??=
                                        TextEditingController(
                                      text: editarNoteJobsRecord.phone,
                                    ),
                                  ...
                                  Padding(
                                    ...
                                    child: FFButtonWidget(
                                      onPressed: () async {
                                        logFirebaseEvent(
                                            'OFERTAS_EDIT_ACTUALIZAR_BTN_ON_TAP');
                                        logFirebaseEvent(
