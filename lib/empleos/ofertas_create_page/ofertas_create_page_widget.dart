    ...
    return Align(
      ...
      child: StreamBuilder<JobsRecord>(
        ...
        builder: (context, snapshot) {
          ...
          final createNoteJobsRecord = snapshot.data!;
          return Material(
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: TextFormField(
                                      controller:
                                        ...
                                        text: createNoteJobsRecord.titleJob,
                                      ),
                                  ...
                                  TextFormField(
                                    controller:
                                        _model.empresaFieldController ??=
                                            TextEditingController(
                                      text: createNoteJobsRecord.company,
                                    ),
                                  ...
                                  TextFormField(
                                    controller:
                                        _model.descriptionFieldController ??=
                                            TextEditingController(
                                      text: createNoteJobsRecord.description,
                                    ),
                                  ...
                                  TextFormField(
                                    controller: _model.emailFieldController ??=
                                        TextEditingController(
                                      text: createNoteJobsRecord.email,
                                    ),
                                  ...
                                  TextFormField(
                                    controller: _model.phoneFieldController ??=
                                        TextEditingController(
                                      text: createNoteJobsRecord.phone,
                                    ),
                                  ...
                                  Padding(
                                    ...
                                    child: InkWell(
                                      ...
                                      onDoubleTap: () async {
                                        logFirebaseEvent(
                                            'OFERTAS_CREATE_SALVAR_BTN_ON_DOUBLE_TAP');
                                        logFirebaseEvent(
                                      ...
                                      child: FFButtonWidget(
                                        onPressed: () async {
                                          logFirebaseEvent(
                                              'OFERTAS_CREATE_SALVAR_BTN_ON_TAP');
                                          if (widget.uid != null) {
                                            logFirebaseEvent(
                                                'Button_validate_form');
                                            if (_model.formKey.currentState ==
                                            ...
                                            await JobsRecord.collection
                                                ...
                                                .set(createJobsRecordData(
                                                  titleJob: _model
                                                      .cargoFieldController
                                                      .text,
                                                  company: _model
                                                      .empresaFieldController
                                                      .text,
                                                  description: _model
                                                      .descriptionFieldController
                                                      .text,
