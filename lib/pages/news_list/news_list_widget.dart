...
class _NewsListWidgetState extends State<NewsListWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'NewsList'});
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                image: DecorationImage(
                  fit: BoxFit.cover,
                  image: Image.network(
                    'https://images.unsplash.com/photo-1476242906366-d8eb64c2f661?q=80&w=2069&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
                  ).image,
                ),
              ),
              child: Container(
                        ...
                        itemBuilder: (context, listViewIndex) {
                          ...
                          return Padding(
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                logFirebaseEvent(
                                    'NEWS_LIST_PAGE_cardView_ON_TAP');
                                logFirebaseEvent('cardView_navigate_to');
