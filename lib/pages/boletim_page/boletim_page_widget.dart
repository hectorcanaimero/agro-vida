...
import 'boletim_page_model.dart';
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  InkWell(
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'BOLETIM_PAGE_PAGE_Text_h9ygy3j6_ON_TAP');
                            ...
                            StreamBuilder<List<PublicationsRecord>>(
                                        ...
                                        children: [
                                          Expanded(
                                            child: InkWell(
                                              ...
                                              onTap: () async {
                                                logFirebaseEvent(
                                                    'BOLETIM_PAGE_PAGE_Row_bl37e5ej_ON_TAP');
                                                logFirebaseEvent(
                                                    'Row_navigate_to');
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'BOLETIM_PAGE_PAGE_Text_jijmqcqy_ON_TAP');
                                    logFirebaseEvent('Text_navigate_to');
                              ...
                              return ListView.separated(
                                ...
                                itemBuilder: (context, listViewIndex) {
                                  ...
                                  return InkWell(
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'BOLETIM_Container_bkwvdab9_ON_TAP');
