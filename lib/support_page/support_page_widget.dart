                    ...
                    child: Container(
                      ...
                      child: StreamBuilder<List<SoporteRecord>>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          List<SoporteRecord> listViewSoporteRecordList =
                              snapshot.data!;
                          return ListView.separated(
                            padding: EdgeInsets.zero,
                            reverse: true,
                            scrollDirection: Axis.vertical,
                            itemCount: listViewSoporteRecordList.length,
                            separatorBuilder: (_, __) => SizedBox(height: 12.0),
                            itemBuilder: (context, listViewIndex) {
                              final listViewSoporteRecord =
                                  listViewSoporteRecordList[listViewIndex];
                              return Align(
                                alignment: AlignmentDirectional(
                                    valueOrDefault<double>(
                                      listViewSoporteRecord.type == 0
                                          ? 1.0
                                          : -1.0,
                                      0.0,
                                    ),
                                ...
                                child: Container(
                                  ...
                                  height: 100.0,
                                  decoration: BoxDecoration(
                                    color: listViewSoporteRecord.type == 0
                                        ? Color(0xFFAED6FF)
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'SUPPORT_PAGE_PAGE_Icon_swz3ko3k_ON_TAP');
                                      logFirebaseEvent(
                                ...
                                InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'SUPPORT_PAGE_PAGE_Icon_zyovq2pu_ON_TAP');
                                    logFirebaseEvent('Icon_backend_call');
