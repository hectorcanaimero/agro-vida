      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'BoletimPage')
              : BoletimPageWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          ...
          path: '/listOfertasPage',
          builder: (context, params) => ListOfertasPageWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          ...
          path: '/listRevistaPage',
          builder: (context, params) => ListRevistaPageWidget(),
        ),
        FFRoute(
          name: 'ListBoletinPage',
          path: '/listBoletinPage',
          builder: (context, params) => ListBoletinPageWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: 'EgresadosPage',
          path: '/egresadosPage',
          builder: (context, params) => EgresadosPageWidget(),
        ),
        FFRoute(
          name: 'ToolsPage',
          path: '/toolsPage',
